...
Place copies of CDN files here for offline use.

Expected files based on current app:
...
Add more files and update assets/offline/offline-cdn-shim.js if needed.
